...
<body>
    <section class=" w-screen sm:h-screen h-dvh flex justify-end grid-cols-6 grid-rows-8 gap-y-0 tablet:flex cp:grid-cols-12 tablet:gap-y-4 relative overflow-x-hidden">
        ...
        {{-- Navigation --}}
        <nav class="sidebar flex flex-col w-[17%] h-full bg-gray-100 absolute top-0 left-0 border-r border-sgline transition-all duration-300 ease-in-out transform translate-x-0">
                            ...
                            <div id="class-list" class="content-box h-auto grid grid-cols-adjust px-4 cp:px-16 cp:mt-8 mt-4 mb-8 tablet:grid-cols-2 md:grid-cols-2 3xl:grid-cols-3 cp:gap-8 gap-4">
                                ...
                                {{-- @if (!$shareableLink) --}}
                                    ...
                                    @else
                                                    ...
                                                    <div class=" w-full grid items-center">
                                                        ...
                                                        <div class="hidden delButton absolute top-[11%] right-[12%] bg-bgcolor py-2 px-2 rounded-md border border-sgline">
                                                            <div class=" flex flex-col text-mainTexts">
                                                                ...
                                                                <form action="{{ route('studentRoom.delete', $room->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                        ...
                                        @foreach ($folders as $folder)
                                            <div class="class-item sm:h-[14rem] h-[10rem] flex justify-between shadow-md rounded-md relative hover:-translate-y-1 transition hover:shadow-lg border border-mainText">
                                                @php
                                                ...
                                                <div class="flex-1 bg-mainText rounded-l-md pt-[21px]">
                                                    <div class="folder-vertical shadow-lg relative w-full h-full bg-gray-100 rounded-l-[5px] overflow-visible">
                                                        <div class=" absolute top-0 right-0 left-0 bottom-0 px-5 pb-5 pt-6 z-[1]">
                                                            <h1 class=" cp:text-4xl text-3xl text-mainText">{{ $folderName }}</h1>
                                                        </div>
