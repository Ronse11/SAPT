...
<body>
    <section class=" w-screen sm:h-screen h-dvh flex justify-end grid-cols-6 grid-rows-8 gap-y-0 tablet:flex cp:grid-cols-12 tablet:gap-y-4 relative overflow-x-hidden">
        ...
        @if (session('folderCreated'))
            {{-- SUCCESS APPLYING OF BUTTONS --}}
            <div id="createdFolder" class="absolute right-7 top-[13vh] flex items-center justify-center z-50 transition-all duration-500 ease-in-out opacity-0 pointer-events-none transform -translate-x-[-15rem]">
                <div class="p-4 bg-green-50 rounded-sm border border-green-300 shadow-lg max-w-sm w-full pointer-events-none">
                    <div class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
        ...
        @if (session('folderDeleted'))
            {{-- SUCCESS APPLYING OF BUTTONS --}}
            <div id="deletedFolder" class="absolute right-7 top-[13vh] flex items-center justify-center z-50 transition-all duration-500 ease-in-out opacity-0 pointer-events-none transform -translate-x-[-15rem]">
                <div class="p-4 bg-green-50 rounded-sm border border-green-300 shadow-lg max-w-sm w-full pointer-events-none">
                    <div class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
            ...
            <div class="sidebar flex flex-col lg:w-[17%] w-[5.3rem] h-full bg-gray-100 absolute top-0 left-0 border-r border-sgline">
                <div class="flex h-[5.5rem] items-center justify-between pl-8 border-b border-sgline">
                    <div class="flex items-center">
                        <img class=" w-8 h-8 lg:mb-3 mr-1 lg:block hidden" src="{{ Vite::asset('resources/images/saptlogo.svg') }}" alt="Logo">
                        <h1 class=" text-xl font-normal text-black select-none tracking-widest lg:text-3xl lg:block sm:hidden">APT</h1>
                    </div>
                    <div class="relative group">
                        <button id="menu-bar" class=" -mb-1 lg:text-4xl pt-1 cp:text-3xl"><i class='bx bx-menu text-mainText hover:text-subtText mr-6'></i></button>
                ...
                <div class=" py-4 flex flex-col items-center px-4">
                    <a href="{{ route('student-home') }}"
                        ...
                        <span class="lg:block hidden text-base ">Home</span>
                    </a>
                    <a href="{{ route('student-calendar') }}"
                        ...
                        <span class="lg:block hidden text-base ">Calendar</span>
                    </a>
                    <a href="{{ route('student-setting') }}"
                    class="w-full nav-link text-md  text-mainText hover:bg-navHover hover:text-mainText rounded-md pl-4 py-3">
                    <i class="bx bxs-cog pr-4 text-xl"></i>
                    <span class="lg:block hidden text-base ">Settings</span>
                </a>
                </div>
                    ...
                    <div class="sticky top-0 left-0 right-0 py-4 px-4 border-t border-sgline">
                        <button class="class-button w-full nav-link text-md flex items-center justify-between text-mainText hover:bg-navHover hover:text-mainText rounded-md pl-4 py-3">
                            <div class=" flex items-center">
                                ...
                                <span class="text-base lg:block hidden ">Class</span>
                            </div>
                            <div class=" h-full flex items-center lg:block sm:hidden">
                    ...
                    <div class=" py-4 border-t border-sgline px-4">
                        <button
                            ...
                            <div class=" flex items-center">
                                ...
                                <span class="text-base lg:block hidden">Folders</span>
                            </div>
                            <div class=" h-full flex items-center lg:block sm:hidden">
        ...
        @auth
            ...
            <section id="hero" class="hero grid grid-cols-8 grid-rows-8 tablet:col-start-4 tablet:col-span-16 tablet:row-start-1 tablet:row-span-8 cp:col-start-2 cp:col-span-10 small-bp">
                ...
                <div id="show-bar" class="opacity-0 pointer-events-none z-50 absolute 1025:hidden top-0 left-0 bottom-0 w-0 transition-all duration-500 ease-in-out">            
                ...
                <div class="row-start-1 row-span-8 col-start-1 col-span-8 overflow-y-auto overflow-scrolls z-10 bg-bgcolor">
                    <div class="header-holder w-full flex flex-col justify-center items-center h-[5.5rem] md:px-16 sm:px-8 px-4 tablet:items-start sticky top-0 left-0 z-40 cp:gap-8 bg-bgcolor border-b border-sgline transition-all duration-300 ease-in-out">
                        {{-- Header --}}
                    ...
                    <div class="flex">
                        <div class="flex-1 flex flex-col relative">
                            <div class="adjust-pleft hidden sm:flex items-center gap-4 w-full md:py-8 py-6 md:pl-16 pl-8 sticky top-[5.5rem] left-0 bg-bgcolor z-10">
                                ...
                                <h2 class=" md:text-xl text-lg text-mainText">Home > Student-Room</h2>
                            </div>
                                        ...
                                        @foreach ($roomsWithUrls as $room)
                                            <div class="class-item h-[10rem] md:h-[14rem] flex rounded-md shadow-md relative hover:-translate-y-1 transition hover:shadow-lg border border-mainText">
                                                ...
                                                <div class=" flex-1 h-full rounded-l-md overflow-hidden">
                                                    <div class=" w-full h-full flex flex-col justify-between bg-gray-100 file-vertical shadow-sm relative overflow-visible rounded-l-md p-3 md:p-5">
                                                        <div class=" w-full">
                                            ...
                                            <div class="class-item md:h-[14rem] h-[10rem] flex justify-between shadow-md rounded-md relative hover:-translate-y-1 transition hover:shadow-lg border border-mainText">
                                                ...
                                                <div class=" w-[15%] h-full flex flex-col justify-between bg-bgcolor rounded-r-md border-l border-mainText py-5">
                                                    ...
                                                    <div class="hidden delButton absolute top-[6%] right-[12%] bg-bgcolor py-2 px-2 rounded-md border border-sgline z-40">
                                                        <div class=" flex flex-col text-mainTexts">
                                                            <form action="{{ route('studentFolder.delete', $folder->id) }}" method="post" class="delete-confirm-form">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="px-8 py-2 w-full hover:bg-navHover rounded-md">Delete</button>
                                                            </form>
                                                    ...
                                                    <div class="w-full flex justify-center -mb-2">
                                                        <a href="{{ route('student-folder', $folder->id) }}" class="">
                                                            <i class='bx bxs-folder-open text-4xl text-mainText'></i>
                                                        </a>
                                                    </div>
                                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const createdFolder = document.getElementById('createdFolder');
            const deletedFolder = document.getElementById('deletedFolder');
            ...
            setTimeout(() => {
                ...
                if (createdFolder) {
                    const msg = "Folder Created Successfully!";
                    floatMessage(msg, createdFolder, currentMsg);
                }
                if (deletedFolder) {
                    const msg = "Folder Deleted Successfully!";
                    floatMessage(msg, deletedFolder, currentMsg);
                }
                if (movedItemd) {
