...
<body>
    ...
    <section class=" w-full h-screen grid place-content-center bg-bgcolor">
        <div class=" bg-bgcolor rounded-md scale-90">
            <div> 
                ...
                <div>
                    <form action="{{ route('register') }}" method="POST" autocomplete="off">
                        ...
                        {{-- Username --}}
                        <div class=" pb-6">
                            <input type="text" id="username" name="username" class=" md:min-w-96 w-80 outline-mainText py-3 px-5 rounded-md bg-transparent border border-subtText  @error('username') ring-1 ring-red-500 @enderror" placeholder="Username" value="{{old('username')}}" autocomplete="off">
                        ...
                        {{-- Email --}}
                        <div class=" pb-6">
                            <input type="text" id="email" name="email" class=" md:min-w-96 w-80 outline-mainText py-3 px-5 rounded-md bg-transparent border  border-subtText  @error('email') ring-1 ring-red-500 @enderror" placeholder="Email" value="{{old('email')}}" autocomplete="off">
                        ...
                        <div class=" pb-6 relative">
                            <input type="password" id="password" name="password" class="pass md:min-w-96 w-80 outline-mainText py-3 px-5 rounded-md bg-transparent border  border-subtText @error('password') ring-1 ring-red-500 @enderror" placeholder="Create password">
