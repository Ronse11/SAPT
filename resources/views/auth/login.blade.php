...
<body>
    ...
    <section class=" w-full h-screen grid place-content-center bg-bgcolor">
        <div class=" bg-bgcolor rounded-md relative md:scale-100 scale-90">
                <h1 class=" text-center mb-5 text-3xl font-bold">Welcome back</h1>
                <div>
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class=" pb-6 relative">
                            <input type="password" id="password" name="password" class="pass  md:min-w-96 w-80 outline-mainText py-3 px-5 rounded-md bg-transparent border md:border-2 border-subtText @error('password') ring-1 ring-red-500 @enderror" placeholder="Password">
