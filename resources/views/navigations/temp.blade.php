...
<body>
    <section class=" w-screen h-screen bg-slate-500 flex justify-end grid-cols-6 grid-rows-8 gap-y-0 tablet:flex cp:grid-cols-12 tablet:gap-y-4 relative overflow-x-hidden">
        ...
        <section class=" absolute top-0 right-0 left-0 bottom-0 flex items-center justify-center z-50  backdrop-blur-md">
            <div class="welcome-animation md:w-[24rem] md:p-8 w-[18rem] bg-bgcolor border border-sgline flex flex-col p-6 rounded-md gap-4 relative">
        ...
        @auth
        {{-- Body --}}
        <section id="hero" class="hero grid grid-cols-8 grid-rows-8 tablet:col-start-4 tablet:col-span-16 tablet:row-start-1 tablet:row-span-8 cp:col-start-2 cp:col-span-10">
            <div class="row-start-1 row-span-8 col-span-8 overflow-y-auto overflow-scrolls z-10 bg-bgcolor flex flex-col">
                <div class="w-full flex flex-col justify-center items-center h-[5.5rem] pr-8 tablet:items-start sticky top-0 left-0 z-40 cp:gap-8 bg-bgcolor border-b border-sgline ">      
                    ...
                    <header class=" w-full row-start-1 row-span-1 flex justify-between items-center tablet:shadow-none z-40">
                        ...
                        {{-- SEARCH SECTION HERE! --}}
                        <div class=" h-full w-full row-start-1 row-span-1 md:flex hidden items-center col-start-4 px-16 z-40 ">
                ...
                <div class="flex flex-1">
                    <div class="flex-1 flex flex-col bg-bgcolor">
                        <div class="hidden md:flex items-center gap-4 w-full py-8 px-16 sticky top-[5.5rem] left-0 z-10">
