        ...
        <section id="sample" class="teacher-choices row-start-2 col-start-1 col-span-6 cp:col-start-1 cp:col-span-16 cp:row-start-3 cp:row-span-13 small-bp ">
            ...
            <div class="row-start-3 w-full h-full overflow-x-auto zoom-container relative text-sm">
                <div class="t-ble w-full">
                    ...
                    <div class=" flex justify-center py-8 bg-sgcolorBG">
                        <div class=" w-[612px] h-auto p-3 bg-white border border-sgcolorSub shadow-md">
                            <table class="main-table w-full" id="main-table" data-table="main-table" data-room-id="{{ $room->id }}" data-teacher-id="{{ $room->teacher_id }}" data-row-start="{{ $selected }}">
                                ...
                                $mergedRows = [
                                    2  => [
                                        ['text' => 'CENTRAL PHILIPPINES STATE UNIVERSITY', 'class' => 'text-[14px] font-bold', 'start_col' => 0, 'colspan' => 19]
                                    ],
                                    3  => [
                                        ['text' => 'Kabankalan City, Negros Occidental', 'class' => 'font-normal text-[11px]', 'start_col' => 0, 'colspan' => 19]
                                    ],
                                    4  => [
                                        ['text' => 'GRADING SHEET', 'class' => 'text-[14px] font-bold', 'start_col' => 0, 'colspan' => 19]
                                    ],
                                    6  => [
                                        ['text' => 'Subject Code: <span class="font-bold">GEC 6</span>', 'class' => 'text-[13px] text-start', 'start_col' => 0, 'colspan' => 8],
                                        ['text' => 'Descriptive Title: <span class="font-bold">Art Appreciation</span>', 'class' => 'text-[13px] text-start', 'start_col' => 8, 'colspan' => 11]
                                    ],
                                    7  => [
                                        ['text' => 'Course/Year/Section: <span class="font-bold">BSAB 1D</span>', 'class' => 'text-[13px] text-start', 'start_col' => 0, 'colspan' => 8],
                                        ['text' => 'Units: <span class="font-bold">3</span>', 'class' => 'text-[13px] text-start', 'start_col' => 8, 'colspan' => 11]
                                    ],
                                    8  => [
                                        ['text' => '(Grades must be written in <span class="font-bold">BLACK</span> or <span class="font-bold text-blue-500">BLUE</span> ink. 
                                            <span class="font-bold text-red-500">CONDITIONAL OR FAILURE</span> in <span class="font-bold text-red-500">RED</span> ink)',
                                        'class' => 'italic text-[10px]', 'start_col' => 0, 'colspan' => 19]
                                    ],
                                    9  => [
                                        ['text' => 'NAMES', 'class' => 'font-bold text-[14px]', 'start_col' => 0, 'colspan' => 2],
                                        ['text' => 'C', 'class' => 'font-bold text-[14px]', 'start_col' => 2, 'rowspan' => 2],
                                        ['text' => 'P', 'class' => 'font-bold text-[14px]', 'start_col' => 3, 'rowspan' => 2],
                                        ['text' => 'A', 'class' => 'font-bold text-[14px]', 'start_col' => 4, 'rowspan' => 2],
                                        ['text' => 'Mid', 'class' => 'font-bold text-[14px]', 'start_col' => 5],
                                        ['text' => 'N.', 'class' => 'font-bold text-[14px]', 'start_col' => 6],
                                        ['text' => 'C', 'class' => 'font-bold text-[14px]', 'start_col' => 7, 'rowspan' => 2],
                                        ['text' => 'P', 'class' => 'font-bold text-[14px]', 'start_col' => 8, 'rowspan' => 2],
                                        ['text' => 'A', 'class' => 'font-bold text-[14px]', 'start_col' => 9, 'rowspan' => 2],
                                        ['text' => 'T', 'class' => 'font-bold text-[14px]', 'start_col' => 10],
                                        ['text' => 'N.', 'class' => 'font-bold text-[14px]', 'start_col' => 11],
                                        ['text' => 'Mid', 'class' => 'font-bold text-[14px]', 'start_col' => 12],
                                        ['text' => 'Final', 'class' => 'font-bold text-[14px]', 'start_col' => 13],
                                        ['text' => 'FR%', 'class' => 'font-bold text-[14px]', 'start_col' => 14],
                                        ['text' => 'N', 'class' => 'font-bold text-[14px]', 'start_col' => 15],
                                        ['text' => 'Credit', 'class' => 'font-bold text-[14px]', 'start_col' => 16, 'rowspan' => 2],
                                        ['text' => 'Remarks', 'class' => 'font-bold text-[14px]', 'start_col' => 17, 'rowspan' => 2],
                                    ],
                                    10  => [
                                        ['text' => '(Arrange alphabetically regardless of sex)', 'class' => 'italic text-[10px]', 'start_col' => 0, 'colspan' => 2],
                                        ['text' => 'Gr.', 'class' => ' text-[13px]', 'start_col' => 2],
                                        ['text' => 'Eqv.', 'class' => ' text-[13px]', 'start_col' => 3],
                                        ['text' => 'F.Gr', 'class' => ' text-[13px]', 'start_col' => 4],
                                        ['text' => 'Eqv.', 'class' => ' text-[13px]', 'start_col' => 5],
                                        ['text' => '40%', 'class' => ' text-[13px]', 'start_col' => 6],
                                        ['text' => '60%', 'class' => ' text-[13px]', 'start_col' => 7],
                                        ['text' => 'Eqv.', 'class' => ' text-[13px]', 'start_col' => 8],
                                        ['text' => 'Eqv.', 'class' => ' text-[13px]', 'start_col' => 9],
                                    ],
                                    41 => [
                                        ['text' => 'Another row spanning different columns', 'class' => 'bg-yellow-200 italic text-sm', 'start_col' => 0, 'colspan' => 19]
                                    ]
                                ];
                                ...
                                <tr class="relative">
                                    @php
                                        $isMergedRow = isset($mergedRows[$row]);
                                    @endphp
                                
                                    @if ($isMergedRow)
                                        @php
                                            $currentRowData = $mergedRows[$row];
                                            $lastCol = 0;
                                        @endphp
                                
                                        @foreach ($currentRowData as $cellData)
                                            @php
                                                $start_col = $cellData['start_col'];
                                                $colspan = $cellData['colspan'] ?? 1;
                                                $rowspan = $cellData['rowspan'] ?? 1;
                                            @endphp
                                
                                            {{-- Skip cells that fall within a rowspan --}}
                                            @for ($col = $lastCol; $col < $start_col; $col++)
                                                <td class="border border-cursor">&nbsp;</td>
                                            @endfor
                                
                                            {{-- Render merged cell --}}
                                            <td class="h-auto student-cell cursor-cell border border-cursor caret-transparent text-center {{ $cellData['class'] }}"
                                                colspan="{{ $colspan }}"
                                            ...
                                            @for ($r = 0; $r < $rowspan; $r++)
                                                @for ($c = 0; $c < $colspan; $c++)
                                                    @php
                                                        $mergedCells[$row + $r][$start_col + $c] = true;
                                                    @endphp
                                                @endfor
                                            @endfor
                                
                                            @php
                                                $lastCol = $start_col + $colspan;
                                            @endphp
                                        @endforeach
                                
                                        {{-- Fill remaining columns with empty cells if needed --}}
                                        {{-- @for ($col = $lastCol; $col < count($sequences); $col++)
                                            <td class="border border-cursor">&nbsp;</td>
                                        @endfor --}}
                                
                                    @else
                                        {{-- Render normal table cells, skipping spanned ones --}}
                                        @for ($col = 0; $col < count($sequences); $col++)
                                            @php
                                            ...
                                            <td id="cell" 
                                                class="h-auto text-14px student-cell cursor-cell border border-cursor caret-transparent text-center"
