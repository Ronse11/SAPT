                    ...
                    <div class="row-start-1 row-span-8 col-start-1 col-span-8 overflow-y-auto overflow-scrolls z-10 bg-bgcolor">
                        ...
                        <div class="flex">
                            <div class="flex-1 flex flex-col relative">
                                <div class="adjust-pleft flex items-center gap-4 w-full pt-8 pb-8 pl-16 sticky top-[12%] left-0 bg-bgcolor z-10">
                                    <h1 class=" text-4xl text-mainText font-semibold"> {{ auth()->user()->username }} </h1>
                                    <div class=" h-full border-r-2 border-mainText"></div>
                                    <h2 class=" text-xl text-mainText">Home > Teacher-Room > {{$folderName->folder_name}}</h2>
                                </div>
                                {{-- Class Box --}}
                                @if ($roomsWithUrls->isEmpty())
                                <div class=" mx-16 h-[70vh] grid place-items-center">
                                ...
                                @else
                                    <div id="class-list" class="content-box h-auto grid grid-cols-adjust px-16 mt-8 mb-8 tablet:grid-cols-2 md:grid-cols-2 3xl:grid-cols-3 gap-8">
                                        @foreach ($roomsWithUrls as $room)
                                            <div class="class-item h-[14rem] flex bg-mainText rounded-md shadow-md relative hover:-translate-y-1 transition hover:shadow-lg border border-mainText">
                                                @php
                                                ...
                                                @endphp
                                                <div class=" flex-1 h-full rounded-md">
